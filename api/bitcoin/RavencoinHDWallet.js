...
/**!!!
 * A Ravencoin Hierarchical Deterministic (HD) Wallet JS Implementation
 * 
...
export default class RavencoinHDWallet {
    ...
    constructor() {
        ...
        /**
         * Ravencoin Legacy Address - Derived from the Grand Child Public Key Hash
         */

        this.ravencoinLegacyAddress = ''

        /**
         * TESTNET Ravencoin Legacy Address (Derived from the Grand Child Public Key Hash) - THIS IS TESTNET
         */

        this._travencoinLegacyAddress = ''
    ...
    generateSeedHash(seed) {
        ...
        const rvn = utils.stringtoUTF8Array('');
        const buffer = utils.appendBuffer(seed.reverse(), rvn);
    ...
    generateDerivedChildKeys() {
        ...
        const derivePublicGrandChildKey = () => {
            ...
            /**
             * Derive Ravencoin Legacy Address
             */
            ...
            // Append CheckSum
            const _ravencoinLegacyAddress = k.concat(...addressCheckSum)

            // Convert to Base58
            this.ravencoinLegacyAddress = Base58.encode(_ravencoinLegacyAddress)


            /**
             * Derive TESTNET Ravencoin Legacy Address
             */
            ...
            // Append CheckSum
            const _travencoinLegacyAddress = tK.concat(...tAddressCheckSum)

            // Convert to Base58
            this._travencoinLegacyAddress = Base58.encode(_travencoinLegacyAddress)
        }
    ...
    returnWallet() {
        ...
        const wallet = {
            ...
            address: this.ravencoinLegacyAddress,
            _taddress: this._travencoinLegacyAddress
        }
